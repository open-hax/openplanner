                              ...
                              (map (fn [tool-id]
                                     {:id tool-id
                                      ...
                                      :description (case tool-id
                                                     ...
                                                     "contract.list" "List all contract IDs in the registry"
                                                     "contract.read" "Read the EDN text of a contract by ID"
                                                     "contract.write" "Create or update a contract by writing EDN text"
                                                     "contract.validate" "Validate EDN contract text without saving"
